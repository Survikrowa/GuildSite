          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg-8">
                <h1 className="recruit__heading display-4 mt-5 mb-3">
                  Join our ranks!
                </h1>
                <h2 className="recruit__subheading mb-5">
                  Before you will send us your application, see out our
                  policies.
                </h2>
              </div>
              <div className="col-12 col-lg-4">
                <svg
                  className="recruit__note h-75"
