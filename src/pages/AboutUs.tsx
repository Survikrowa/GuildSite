        ...
        <section className="about">
          <div className="container">
            <p className="about__intro">
              ...
              veritatis perferendis nostrum. Eaque minima, itaque autem
              corrupti, nihil sed natus delectus fuga modi voluptatibus optio
              consequatur iste, quibusdam maxime nisi ipsum. Molestiae
              provident, necessitatibus officiis in repellendus fugiat velit
              voluptatibus dolores unde itaque aut aperiam doloribus blanditiis
              aspernatur fuga? Sit neque cum sunt fugit at suscipit vel quae
              nihil amet necessitatibus?
            </p>
