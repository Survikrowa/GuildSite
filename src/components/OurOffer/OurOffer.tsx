  ...
  return (
    <section className="features py-5">
      <div className="container">
        <h2 className="features__heading display-4 text-center mt-5">
          Why Muzykanci?
        </h2>
